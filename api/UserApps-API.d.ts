...
declare interface App {
	 ...
	 */
	onAppEventReceived?(appInstance:AppInstance, type:string, data:any):void;
	/**
...
declare class AppContent {
	 ...
	 */
	public addCloseListener(callback:Function):void;
}
...
declare class AppInstance {
	 ...
	 */
	public sendAppEvent(type:string, data:any):void;
	/**
...
declare class BotUser extends User {
	 ...
	 */
	public transferKnuddel(receivingUserOrAccount:(User|KnuddelAccount), knuddelAmount:KnuddelAmount, parameters?:any):void;
}
...
declare class Client {
	 ...
	 */
	public static sendEvent(type:string, data:any):void;
	/**
	 ...
	 */
	public static addEventListener(type:string, callback:Function):void;
	/**
...
declare class DiceConfigurationFactory {
	 ...
	 * <b>Beispiel:</b> /diceo 1w4 -> 4 -> 4 -> 3 = 11
	 */
	public setUseOpenThrows(shouldUseOpenThrow:boolean):void;
	/**
...
declare class ExternalServerAccess {
	 ...
	 */
	public getURL(urlString:string, parameters?:any):void;
	/**
	 * Macht einen POST-Request auf die übergebene URL und liefert den Inhalt zurück.
	 * Diese Methode ist eine Convenience-Methode für externalServerAccess.callURL().
	 */
	public postURL(urlString:string, parameters?:any):void;
	/**
	 ...
	 * Diese Methode ist eine Convenience-Methode für externalServerAccess.callURL().
	 */
	public touchURL(urlString:string, parameters?:any):void;
	/**
	 * Macht einen Request auf die übergebene URL.
	 */
	public callURL(urlString:string, parameters?:any):void;
}
...
declare class HTMLFile {
	 ...
	 *
	 */
	public constructor(assetPath:string, pageData?:any);
	/**
...
declare class KnuddelAccount {
	 ...
	 */
	public use(knuddelAmount:KnuddelAmount, displayReasonText:string, parameters?:any):void;
}
...
declare class KnuddelsServer {
	 ...
	 *
	 */
	public static getAppDeveloper():User;
	/**
	 *
	 */
	 ...
	 *
	 */
	public static userExists(nick:string):boolean;
	/**
	 *
	 */
	public static getUserId(nick:string):number;
	/**
	 *
	 */
	public static canAccessUser(userId:number):boolean;
	/**
	 *
	 */
	public static getNickCorrectCase(userId:number):string;
	/**
	 *
	 */
	 ...
	 *
	 */
	public static isTestSystem():boolean;
	/**
	 ...
	 *
	 */
	public static getAppManagers():User[];
	/**
	 ...
	 */
	public static createKnuddelPot(knuddelAmount:KnuddelAmount, params?:any):KnuddelPot;
	/**
...
declare class RandomOperations {
	 ...
	 */
	public static getRandomObject(objects:any[]):any;
	/**
	 * Mischt das Array der übergebenen Objekte und liefert es zurück.
	 */
	public static shuffleObjects(objects:any[]):any[];
	/**
...
declare class ToplistAccess {
	 ...
	 */
	public createOrUpdateToplist(userPersistenceNumberKey:string, displayName:string, parameters?:any):Toplist;
}
...
declare class UserAccess {
	 ...
	 */
	public eachAccessibleUser(callback:Function, parameters?:any):void;
}
...
declare class UserPersistenceNumbers {
	 ...
	 */
	public static getCount(key:string, parameters?:any):number;
	/**
	 ...
	 * <br /><strong>Hinweis:</strong> Da diese Methode ein Batch-Update ist werden keine Change-Listener (ToplistRankChangeEvent, ToplistLabelChangeEvent) ausgelöst.
	 */
	public static addNumber(key:string, value:number, parameters?:any):number;
	/**
	 ...
	 */
	public static getSortedEntries(key:string, parameters?:any):UserPersistenceNumberEntry[];
	/**
	 ...
	 */
	public static getSortedEntriesAdjacent(key:string, user_or_userId:(User|number), parameters?:any):UserPersistenceNumberEntry[];
	/**
	 ...
	 */
	public static getPosition(key:string, user_or_userId:(User|number), parameters?:any):number;
	/**
	 ...
	 */
	public static getRank(key:string, user_or_userId:(User|number), parameters?:any):number;
	/**
	 ...
	 */
	public static each(key:string, callback:Function, parameters?:any):void;
	/**
